        ...
        itemsContent += `
            <div class="item">
              ...
              <div class="item__details">
                ...
                <div class="item__price" id="item__price">$${item.price}</div>
              </div>
              <div class="item__add">
    ...
    menuArray.forEach(function(item) {
            orderListContent += `
                <div class="list__item">
                    ...
                    <span class="order__remove" data-${item.name.toLowerCase()}-del="${item.id}-del">remove</span>
                    <span class="order__price" id="${item.name.toLowerCase()}-order">$0</span>
                </div>
            `
    })
...
function handlePizzaClick() {
        ...
        pizzaOrder.innerHTML = `
            <span class="order__price" id="pizza-order">${orderArray[0].quantity} x $${orderArray[0].price}</span>
            `
        collectTotal()
}
...
function handleHamburgerClick() {
        ...
        hamburgerOrder.innerHTML = `
            <span class="order__price" id="hamburger-order">${orderArray[1].quantity} x $${orderArray[1].price}</span>
            `    
        collectTotal()
}
...
function handleBeerClick() {
        ...
        beerOrder.innerHTML = `
            <span class="order__price" id="beer-order">${orderArray[2].quantity} x $${orderArray[2].price}</span>
            `    
        collectTotal()
}
...
function handlePizzaDelClick() {
    if (orderArray[0].quantity > 1) {
        ...
        orderArray[0].quantity--
        pizzaOrder.innerHTML = `
            <span class="order__price" id="pizza-order">$${orderArray[0].price}</span>
            `
        collectTotal()
    }
}
...
function handleHamburgerDelClick() {
    if (orderArray[1].quantity > 1) {
        ...
        orderArray[1].quantity--
        hamburgerOrder.innerHTML = `
            <span class="order__price" id="hamburger-order">$${orderArray[1].price}</span>
            `
        collectTotal()
    }
}
...
function handleBeerDelClick() {
    ...
    if (orderArray[2].quantity === 1) {
        ...
        orderArray[2].quantity--
        beerOrder.innerHTML = `
            <span class="order__price" id="beer-order">$${orderArray[2].price}</span>
            `
        collectTotal()
    }
}
